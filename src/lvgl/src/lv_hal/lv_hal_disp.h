...
#define LV_ATTRIBUTE_FLUSH_READY
    ...
    void (*gpu_blend_cb)(struct _disp_drv_t * disp_drv, lv_color_t * dest, const lv_color_t * src, uint32_t length,
                         lv_opa_t opa);
#endif
		void (*gpu_blend_cb)(struct _disp_drv_t *disp_drv, lv_color_t *dest, const lv_color_t *src, const lv_area_t *src_area, const lv_area_t *dst_area, lv_opa_t opa, bool a_color);
