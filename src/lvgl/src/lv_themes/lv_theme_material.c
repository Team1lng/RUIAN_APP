...
#define COLOR_SCR        (IS_LIGHT ? lv_color_hex(0xeaeff3) :  LV_COLOR_BLACK /*lv_color_hex(0x444b5a)*/)
#define COLOR_SCR_TEXT   (IS_LIGHT ? lv_color_hex(0x3b3e42) :  LV_COLOR_WHITE /*lv_color_hex(0xe7e9ec)*/)

/*BUTTON*/
#define COLOR_BTN           (IS_LIGHT ? lv_color_hex(0xffffff) : LV_COLOR_BLACK /*lv_color_hex(0x586273)*/)
...
/*BACKGROUND*/
#define COLOR_BG            (IS_LIGHT ? lv_color_hex(0xffffff) :  LV_COLOR_BLACK /*lv_color_hex(0x586273)*/)
...
#define BORDER_WIDTH            0 //LV_DPX(2)
#define OUTLINE_WIDTH           0 //((theme.flags & LV_THEME_MATERIAL_FLAG_NO_FOCUS) ? 0 : LV_DPX(2))
#define IS_LIGHT 0//(theme.flags & LV_THEME_MATERIAL_FLAG_LIGHT)
...
static void basic_init(void)
{
    ...
    lv_style_set_bg_opa(&styles->scr, LV_STATE_DEFAULT, LV_OPA_TRANSP);
    ...
    lv_style_set_radius(&styles->bg, LV_STATE_DEFAULT, 0/*LV_DPX(8)*/);
    lv_style_set_bg_opa(&styles->bg, LV_STATE_DEFAULT, LV_OPA_0);
    ...
    lv_style_set_bg_color(&styles->bg_click, LV_STATE_CHECKED, COLOR_BG_PR/*COLOR_BG_CHK*/);
    lv_style_set_bg_color(&styles->bg_click, LV_STATE_PRESSED | LV_STATE_CHECKED, COLOR_BG_PR/*COLOR_BG_PR_CHK*/);
    ...
    lv_style_set_border_color(&styles->bg_click, LV_STATE_FOCUSED | LV_STATE_PRESSED, COLOR_BG_PR/*lv_color_darken(theme.color_primary,
                                                                                                      LV_OPA_20)*/);
    ...
    lv_style_set_radius(&styles->btn, LV_STATE_DEFAULT, /*LV_RADIUS_CIRCLE*/0);
    lv_style_set_bg_opa(&styles->btn, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&styles->btn, LV_STATE_DEFAULT, LV_COLOR_BLACK);
    lv_style_set_bg_color(&styles->btn, LV_STATE_PRESSED, LV_COLOR_BLACK/*COLOR_BTN_PR*/);
    lv_style_set_bg_color(&styles->btn, LV_STATE_CHECKED, LV_COLOR_BLACK);
    lv_style_set_bg_color(&styles->btn, LV_STATE_CHECKED | LV_STATE_PRESSED, LV_COLOR_BLACK);
    lv_style_set_bg_color(&styles->btn, LV_STATE_DISABLED, LV_COLOR_BLACK);
    lv_style_set_bg_color(&styles->btn, LV_STATE_DISABLED | LV_STATE_CHECKED, LV_COLOR_BLACK);
    ...
    lv_style_set_pad_inner(&styles->pad_inner, LV_STATE_DEFAULT, lv_disp_get_size_category(NULL) <= LV_DISP_SIZE_MEDIUM ? LV_DPX(20) : LV_DPX(40));
...
static void switch_init(void)
{
    ...
    lv_style_set_pad_top(&styles->sw_knob, LV_STATE_DEFAULT,    - LV_DPX(1));
    lv_style_set_pad_bottom(&styles->sw_knob, LV_STATE_DEFAULT, - LV_DPX(1));
...
static void checkbox_init(void)
{
	...
	//lv_style_set_bg_opa(&styles->cb_bg, LV_STATE_DEFAULT, LV_OPA_TRANSP);
	//lv_style_set_bg_opa(&styles->cb_bg, LV_STATE_CHECKED, LV_OPA_TRANSP);
    ...
    lv_style_set_outline_opa(&styles->cb_bg, LV_STATE_FOCUSED, LV_OPA_TRANSP);
	...
	lv_style_set_bg_opa(&styles->cb_bullet, LV_STATE_DEFAULT, LV_OPA_TRANSP);
	lv_style_set_bg_opa(&styles->cb_bullet, LV_STATE_CHECKED, LV_OPA_TRANSP);
...
static void textarea_init(void)
{
    ...
    lv_style_set_text_color(&styles->ta_placeholder, LV_STATE_DEFAULT,
                            IS_LIGHT ? lv_color_hex(0xffffff) : lv_color_hex(0xa1adbd));
#endif
}
...
static void list_init(void)
{
    ...
    lv_style_set_bg_color(&styles->list_btn, LV_STATE_PRESSED, LV_COLOR_BLACK);
...
static void ddlist_init(void)
{
	...
	lv_style_set_border_side(&styles->ddlist_page, LV_STATE_DEFAULT, LV_BORDER_SIDE_BOTTOM);
...
static void tabview_win_shared_init(void)
{
    ...
    lv_style_set_pad_top(&styles->tabview_btns_bg, LV_STATE_DEFAULT, 0/*LV_DPX(7)*/);
    lv_style_set_pad_left(&styles->tabview_btns_bg, LV_STATE_DEFAULT, 0/*LV_DPX(7)*/);
    lv_style_set_pad_right(&styles->tabview_btns_bg, LV_STATE_DEFAULT, 0/*LV_DPX(7)*/);

    lv_style_reset(&styles->tabview_btns);
    lv_style_set_bg_opa(&styles->tabview_btns, LV_STATE_PRESSED, LV_OPA_COVER);
    lv_style_set_bg_color(&styles->tabview_btns, LV_STATE_PRESSED,LV_COLOR_BLACK/* lv_color_hex3(0x888)*/);
    lv_style_set_text_color(&styles->tabview_btns, LV_STATE_CHECKED, COLOR_SCR_TEXT);
    lv_style_set_pad_top(&styles->tabview_btns, LV_STATE_DEFAULT,0/* LV_DPX(20)*/);
    lv_style_set_pad_bottom(&styles->tabview_btns, LV_STATE_DEFAULT, 0/*LV_DPX(20)*/);
    ...
    lv_style_set_size(&styles->tabview_indic, LV_STATE_DEFAULT, LV_DPX(1));
