...
//    ext->symbol         = LV_SYMBOL_DOWN;
	LV_LOG_ERROR("lv_dropdown_createa:	There is a problem here that needs to be fixed \n");
...
/*****************************************************************************/
	lv_obj_t * led = lv_led_create(ext->page, NULL);
	lv_obj_set_size(led,296,2);
	lv_obj_set_pos(led,0,83);
	lv_obj_set_style_local_bg_color(led, 0, LV_STATE_DEFAULT, lv_color_hex(0x000000));
/*****************************************************************************/
